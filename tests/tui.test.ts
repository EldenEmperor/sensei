...
describe('sprite parsing', () => {
  ...
  it('the committed sprite sheet has the event animations, frames aligned', () => {
    ...
    // thinking/slash = the red-vs-blue duel, scout = the spyglass;
    // minifight/miniscout render one column per working subagent
    expect(Object.keys(anims).sort()).toEqual(['minifight', 'miniscout', 'scout', 'sheath', 'slash', 'spawn', 'thinking']);
